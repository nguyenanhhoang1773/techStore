...
function DetailPage() {
  return (
    <div className="flex justify-center rounded-sm bg-white text-[rgba(0,0,0,0.7)]">
      <div>
        <img
      ...
      <div className="px-[20px] ml-[40px] py-[30px]">
        <h3>Áo Polo Unisex Teelab,Polo form rộng unisex Teelab localbrand</h3>
        <div className="flex mt-[12px] items-center">
          ...
          <span className="ml-[6px] text-[var(--color-primary)] ">Đã Bán</span>
        </div>
        ...
        <div className=" w-[400px] h-full border-[2px] rounded-xl border-[var(--color-primary)]">
          ...
          <div className=" px-[10px] py-[8px] ">
            ...
            <div className="mt-[8px] flex">
              ...
              <span className="ml-[10px]">
                Máy mới 100% , chính hãng Apple Việt Nam. CellphoneS hiện là đại
                lý bán lẻ uỷ quyền iPhone chính hãng VN/A của Apple Việt Nam
              </span>
            </div>
          </div>
        </div>
